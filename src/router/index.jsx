      ...
      <ScrollToTop>
        <Routes>
          <Route element={<ThemeProvider />}>
            ...
            {/* <Route
              path="landing-text-image"
              element={<ImageGenLandingPage />}
            />
            ...
            {/* <Route path="documents">
                ...
                <Route path="edit/:documentId" element={<DocumentsEdit />} />
              </Route>
            ...
            {/* <Route
                  path="writer/:writerslug"
                  element={<TemplatesWriterPage />}
                ></Route> */}
            ...
            {/* <Route path="admin">
              ...
              <Route path="package-manager">
                ...
                <Route path="edit/:packageId" element={<PackageEdit />} />
              </Route>
              <Route path="coupons">
                <Route index element={<CouponsPage />} />
                <Route path="edit/:couponId" element={<CouponsEdit />} />
              </Route>
              <Route path="support">
                <Route index element={<SupportMange />} />
                <Route path="details/:supportId" element={<SupportDetails />} />
              </Route>
